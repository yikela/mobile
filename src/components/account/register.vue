<template>
  <div id="login">
      ...
      <div class="content"> 
          ...
          <x-input title="邮箱:" name="email" placeholder="请输入邮箱" type="text" v-model.trim="email"></x-input>
          <p class="birthday"><datetime v-model="birth" title="生日:" :start-date="'1900-11-11'" :end-date="'2030-11-11'"></datetime></p>
          ...
          <x-input title="邀请码:" name="ref" placeholder="请输入邀请码" type="text" v-model.trim="ref"></x-input>
          <x-button mini plain  @click.native="clickRegister() " class="flex-demo"> 注册</x-button>
      </div>
